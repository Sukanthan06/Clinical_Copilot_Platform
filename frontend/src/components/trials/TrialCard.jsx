    ...
    <div className="card card-hover p-5">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <h3 className="mt-2 font-display text-base font-semibold text-ink-800">{name}</h3>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3 border-t border-mist-200 pt-4 text-xs">
        ...
        <div>
          <p className="flex items-center gap-1 font-semibold uppercase tracking-wide text-ink-400">
            <HiOutlineMapPin className="h-3 w-3" /> Distance
          </p>
          <p className="mt-1 font-mono font-medium text-ink-700">{distance}</p>
        </div>
        <div className="col-span-2">
          <p className="font-semibold uppercase tracking-wide text-ink-400">Eligibility</p>
          <p className="mt-1 text-ink-600">{eligibility}</p>
        </div>
      </div>
